    ...
    for i in range(1000000000000000):
        try:
            ...
            while prefilled_tokens < MAX_ONCE_PREFILL_TOKENS:
                ...
                new_req_len = pending_reqs[0].prompt_len + pending_reqs[0].max_output_len
                total_req_mem = sum(req.prompt_len + req.max_output_len for req in batch)
                if total_req_mem + new_req_len > MEM:
                    break
